...
class PokemonData {
  // Função responsável por retornar um PokemonData
  static String getImage(String pokemonName) {
    // Busca o primeiro pokemon com o nome informado
    Map<String, String>? map = pokemons.firstWhereOrNull((map) =>
        map["name"].toString().toLowerCase() == pokemonName.toLowerCase());

    // Caso exista o pokemon, retorna a imagem
    return AppImages.getPokemonImage(map?["id"] ?? 'None');
  }

  // // Função responsável por retornar um PokemonData
  // static PokemonData getData(String name) {
  //   // Busca o primeiro pokemon com o nome informado
  //   Map<String, String>? map = pokemons.firstWhereOrNull(
  //       (map) => map["name"].toString().toLowerCase() == name.toLowerCase());
  //   try {
  //     // Caso exista o pokemon, retorna o PokemonData contendo o id e o nome
  //     if (map != null) {
  //       return PokemonData.fromJson(map);
  //     }
  //   } catch (e) {
  //     print('Busca o pokemon $name');
  //     print('Encontrado: $map');
  //     print(e);
  //   }
  //   // Caso não exista o pokemon, retorna o PokemonData vazio
  //   return PokemonData(id: name, name: name);
  // }

  static List<Map<String, String>> pokemons = [
    ...
    {"id": "028", "name": "Sandslash"},
    {"id": "029", "name": "Nidoran-f"},
    {"id": "030", "name": "Nidorina"},
    {"id": "031", "name": "Nidoqueen"},
    {"id": "032", "name": "Nidoran-m"},
